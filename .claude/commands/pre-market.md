...
Extract the list of currently-held tickers (needed for sub-agent 4).

STEP 3a — Classify today's market regime. Run these two queries:
...
major macro event requires immediate attention.
